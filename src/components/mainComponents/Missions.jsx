  ...
  return (
    <>
        <Parent id="mission" style = {{borderBottom : `1px solid ${Colors.gold}`}}>
            ...
            <Text>A guidance platform that enables tourists to know the locations, prices, and rating many tourist places and hotels, not only in Egypt but in many countries around the world.</Text>
            <ImageDiv>
                <Img src = {Devils}/>
            </ImageDiv>
        </Parent>
