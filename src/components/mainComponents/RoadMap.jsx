            ...
            {!yourState ? 
                <Container id = "roadmap">
                    ...
                    <TextContainer>
                        ...
                        <Text style = {{left : "160px"}}>Start collection Minting</Text>
                        <Text style = {{left : "175px"}}>NFTs reveal</Text>
                        <Text style = {{left : "190px"}}>Pharaohx.eth subdomain distributing</Text>
                        <Text style = {{left : "205px"}}>Promoting, make a partnerships and building a strong community</Text>
